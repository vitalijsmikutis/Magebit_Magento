<?php
namespace Magebit\AddToCart\Block\AddToCart;

/**
 * Interceptor class for @see \Magebit\AddToCart\Block\AddToCart
 */
class Interceptor extends \Magebit\AddToCart\Block\AddToCart implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productRepository, $data);
    }
    ...
    public function getProductData($productId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductData', func_get_args(), $pluginInfo) : parent::getProductData($productId);
    }
